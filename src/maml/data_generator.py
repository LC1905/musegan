...
class DataGenerator(object):
    ...
    def __init__(self, num_samples_per_class, batch_size, config={}):
        ...
        self.num_samples_per_class = num_samples_per_class # AHA: update_batch_size in main.py; "K" in K-shot.
    ...
    def make_data_tensor(self, train=True):
        ...
        for _ in range(num_total_batches):
            ...
            labels_and_images = get_images(sampled_character_folders, range(self.num_classes), nb_samples=self.num_samples_per_class, shuffle=False)  # AHA: list of tuples (label, image_file_name).
